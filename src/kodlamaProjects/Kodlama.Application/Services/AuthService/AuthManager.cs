...
namespace Kodlama.Application.Services.AuthService
{
    public class AuthManager : IAuthService
    {
        ...
        public void IsAuthenticatorCodeStatus(string AuthenticatorCode)
        {
            //Request Authentivator Code Valided
            bool durum = true;

            if(!durum) throw new BusinessException("No Authentivator Code");
